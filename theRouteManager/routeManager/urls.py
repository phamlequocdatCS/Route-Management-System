...
urlpatterns = [
    ...
    path(
        "password_reset/",
        authentication_views.password_reset_view,
        name="password_reset",
    ),
    ...
    # Register
    path(
        f"{BASE_ROUTE}/register",
        authentication_views.account_create_view,
        name="register",
    ),
    ### VIEWS ###
    # Home and logins
    ...
    # Location
    path(
        f"{BASE_ROUTE}/add_loc_view", location_views.add_loc_view, name="add_loc_view"
    ),
    path(
        f"{BASE_ROUTE}/lookup_loc", location_views.display_locations, name="lookup_loc"
    ),
    # Plan
    ...
    # Bookmark API
    path(
        f"{BASE_ROUTE}/bookmark_location",
        api.bookmark_location,
    ...
    path(
        f"{BASE_ROUTE}/delete_note/<int:note_id>/", api.delete_note, name="delete_note"
    ),
    # Plan API
    path(f"{BASE_ROUTE}/save_route", api.save_route, name="save_route"),
    path(
        f"{BASE_ROUTE}/planner/<int:id>/save_route", api.save_route, name="save_route"
    ),
    path(
    ...
    path(
        f"{BASE_ROUTE}/delete_route/<int:plan_id>/",
        api.delete_route,
        name="delete_route",
    ),
    path(
